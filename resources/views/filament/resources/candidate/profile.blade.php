            ...
            @if ($activeTab === 'overview')
                <div class="sp-cand-overview-grid">
                    ...
                    <div>
                        ...
                        @if ($c->score_written && $c->score_interview)
                            <div>
                                <div class="text-xs uppercase font-bold text-gray-400 tracking-wider mb-2">Internal recommendation</div>
                                <div class="rounded-lg bg-emerald-50 dark:bg-emerald-500/10 p-4 flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-full bg-emerald-100 dark:bg-emerald-500/20 text-emerald-700 dark:text-emerald-400 flex items-center justify-center">👍</div>
                                    <div>
                                        <div class="font-semibold text-base text-gray-950 dark:text-white">Strong Hire</div>
                                        <div class="text-xs text-gray-500 dark:text-gray-400">Per panel evaluation · 3 of 3 evaluators agreed.</div>
                                    </div>
                        ...
                        <div>
                            <div class="text-xs uppercase font-bold text-gray-400 tracking-wider mb-2">Internal notes ({{ count($notes) }})</div>
                            <div class="space-y-2">
                                @forelse ($notes as $n)
                                    <div class="rounded-lg bg-gray-50 dark:bg-white/5 p-3">
                                        <div class="flex items-center gap-2 mb-1">
                    ...
                    <div class="space-y-3">
                        <div class="rounded-lg bg-gray-50 dark:bg-white/5 p-4">
                            <div class="text-xs text-gray-400 font-semibold uppercase">Scores</div>
                            <div class="grid grid-cols-3 gap-2 mt-2">
                                @foreach ([['Written',$c->score_written],['Interview',$c->score_interview],['Micro',$c->score_micro]] as $s)
                                    <div class="text-center">
                                        <div class="font-bold text-xl text-gray-950 dark:text-white">{{ $s[1] ?: '—' }}</div>
                        ...
                        <div class="rounded-lg bg-gray-50 dark:bg-white/5 p-4">
                            <div class="text-xs text-gray-400 font-semibold uppercase mb-2">Verifications</div>
                        ...
                        @if ($v)
                            <div class="rounded-lg bg-gray-50 dark:bg-white/5 p-4">
                                <div class="text-xs text-gray-400 font-semibold uppercase mb-2">Vacancy</div>
                                <div class="font-semibold text-sm text-gray-950 dark:text-white">{{ $v->title }}</div>
                                <div class="text-xs text-gray-500 mt-1">{{ $v->code }} · {{ strtoupper($v->campus) }}</div>
                            </div>
                        @endif
