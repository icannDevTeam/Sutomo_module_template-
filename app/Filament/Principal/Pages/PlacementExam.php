...
class PlacementExam extends Page implements HasForms, HasActions
{
    ...
    public function getViewData(): array
    {
        ...
        $scored      = (clone $scope)->whereNotNull('placement_score')->whereIn('status', ['passed','failed','waitlisted'])->latest('updated_at')->take(20)->get();
